package com.tradeability.legilator.views.main;
...
import com.tradeability.legilator.views.main.MainView;
import com.tradeability.legilator.views.dashboard.DashboardView;
import com.tradeability.legilator.views.masterdetail.MasterDetailView;
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logos/18.png", "GoLegilator logo"));
        logoLayout.add(new H1("GoLegilator"));
